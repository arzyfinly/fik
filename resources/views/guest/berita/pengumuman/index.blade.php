                                    ...
                                    <div class="single-blog-style2__text-holder">
                                        <div class="top">
                                            <div class="category-box">
                                                ...
                                                <p><a href="{{ route('guest.pengumuman-fik') }}" rel="category tag">Pengumuman</a></p>
                                            </div>
                                        </div>
                                        <h3 class="blog-title">
                                            <a href="{{ route('berita-pengumuman-fik.show',$row->id) }}">{{ $row->title }}</a>
                                        </h3>
                                        @if($countString == 100)
                                        ...
                                        <div class="bottom-box">
                                            <div class="btn-box">
                                                <a
                                                    href="{{ route('berita-pengumuman-fik.show',$row->id) }}">
