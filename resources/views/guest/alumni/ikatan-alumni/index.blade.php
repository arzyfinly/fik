                        ...
                        <div id="categories-2" class="widget sidebar-search-box widget_categories">
                            ...
                            <ul>
                                ...
                                <li class="cat-item cat-item-86"><a
                                        href="{{ route('guest.pengumuman-fik') }}">Pengumuman</a>
                                </li>
                                            ...
                                            <div class="inner">
                                                <div class="img-box"
                                                    ...
                                                    <div class="overlay-content">
                                                        <a
                                                            href=" @if ($row->berita->category_berita_id == 1) {{ route('berita-informasi-fik.show', $row->id) }} @elseif($row->berita->category_berita_id == 2) {{ route('berita-pengumuman-fik.show', $row->id) }} @else # @endif"><i
                                                ...
                                                <div class="title-box">
                                                    ...
                                                    <h4>
                                                        <a
                                                            href=" @if ($row->berita->category_berita_id == 1) {{ route('berita-informasi-fik.show', $row->id) }} @elseif($row->berita->category_berita_id == 2) {{ route('berita-pengumuman-fik.show', $row->id) }} @else # @endif">{{ substr($row->title, 0, 30) }}&hellip;</a>
                                                    </h4>
                                                </div>
                                            </div>
                                        </li>
