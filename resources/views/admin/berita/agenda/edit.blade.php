@extends('layout.app')
@section('title', 'Agenda FIK')
@section('agenda-fik-active', 'active')
...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('Agenda FIK') }}</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="./">{{ __('Home') }}</a></li>
            <li class="breadcrumb-item">{{ __('Berita') }}</li>
            <li class="breadcrumb-item">{{ __('Agenda FIK') }}</li>
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">{{ __('Edit Agenda FIK') }}</h6>
                ...
                <div class="table-responsive p-3">
                    <form action="{{ route('agenda-fik.update', $agenda->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
