...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('Program Studi FIK') }}</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="./">{{ __('Home') }}</a></li>
            <li class="breadcrumb-item">{{ __('Akademik') }}</li>
            <li class="breadcrumb-item active" aria-current="page">{{ __('Program Studi FIK') }}</li>
        </ol>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('program-studi-fik.header') }}" method="POST" enctype="multipart/form-data">
                        @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#dataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('program-studi-fik.index') }}",
                    type: 'GET',
                },
                "responsive": true,
                "language": {
